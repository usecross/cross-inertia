...
def test_flash_messages_appear_and_dismiss(page: Page, fastapi_server: str) -> None:
    ...
    close_button = page.locator("div.container button").filter(has=page.locator("svg")).first
    close_button.click()
...
def test_favorites_count_updates_in_real_time(page: Page, fastapi_server: str) -> None:
    ...
    assert count_after_first != initial_count, "Count should have changed after favoriting"
    ...
    assert count_after_second != count_after_first, "Count should have changed after second favorite"
...
def test_flash_message_persists_across_redirect(page: Page, fastapi_server: str) -> None:
...
def test_shared_data_included_in_partial_reloads(page: Page, fastapi_server: str) -> None:
